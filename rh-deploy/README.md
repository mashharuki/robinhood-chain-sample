...
>
> **クロスチェーンswap学習キット**: 他チェーンの資金で Robinhood Chain 上の Stock Token を買う、Chainlink CCIP 準拠のクロスチェーンswapサンプルも同梱しています。使い方は [docs/crosschain-swap-learning.md](./docs/crosschain-swap-learning.md) を参照。
